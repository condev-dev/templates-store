...
const Footer = () => {
  return (
    <footer className="footer-main w-100 d-flex flex-column mt-auto">
      <section className="w-100 d-flex justify-content-between align-items-center py-4 my-1">
        <div className="d-flex flex-column align-items-start w-50 ps-5">
          ...
          <p className="footer-information-text mt-3">
            ...
            اورجینال | نوین وردپرسقالب وردپرس | پوسته وردپرس | مرجع دانلود و
            خرید تم وردپرس اورجینال | نوین وردپرسقالب وردپرس | پوسته وردپرس |
            مرجع دانلود و خرید تم وردپرس اورجینال | نوین وردپرسقالب وردپرس |
            پوسته وردپرس | مرجع دانلود و خرید تم وردپرس اورجینال | نوین خرید تم
            وردپرس اورجینال | نوین وردپرسقالب وردپرس | پوسته وردپرس |
          </p>
        </div>
